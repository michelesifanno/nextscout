...
export default function OtherPlayers({ stats }) {
    ...
    const filteredPlayers = players ? players.filter((player) => player.position == positionName) : [];

    console.log("OtherPlayers players:", players);

    return (
        <Container sx={{ display: 'block', backgroundColor: '#121212', p: { xs: 3, md: 4 }, mt: 2, borderRadius: 2 }}>
